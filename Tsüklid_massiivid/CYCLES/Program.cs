...
//else
//{
//    console.writeline("ma ei saa sinust aru");
//}

//Console.WriteLine("Kui kaua sa oled sa viimasel nädalal mänginud");
//int tunnid = 0;
...
//}
//else if (tunnid >= 1 && tunnid <= 10)
//{
//    Console.WriteLine("natuke liiga paljuks läheb kodutööd kannatavad");
//}
//else if (tunnid >= 10 && tunnid <= 20)
//{
//    Console.WriteLine("liiga palju mängid kas sa koolis üldse nii jõuad");
//}
//else if (tunnid >= 20 && tunnid <= 40)
//{
//    Console.WriteLine("sul on vist vaja psühholoogi");
//}
//else if (tunnid >= 20 && tunnid <= 150) ;
...
parool = int.Parse(Console.ReadLine());
{
    ...
    while (parool < 0 && parool > 999) ;
 
    
    
}
while (parool < 9999 && parool > 1000) ;
parool = int.Parse(Console.ReadLine());
